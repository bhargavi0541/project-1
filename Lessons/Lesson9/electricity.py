...
if units<=50:
    ...
    amount= (units-50)*3.25+(50*2.6) 
    surcharge=35
elif units<=200:
    amount= (units-100)*5.26+(50*2.6)+(50*3.25)     
    surcharge=45
else:
    amount= (units-200)*8.45+(50*2.6)+(50*3.25)+(100*5.26)
    surcharge=75
total= amount+surcharge
print(f"The total electricity bill is {total:.2f}")  
